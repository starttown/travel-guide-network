...
"""
Weather Connector - Worker Agent that receives city/date via HTTP, fetches weather, 
and posts structured data to the network for AI processing.
"""
